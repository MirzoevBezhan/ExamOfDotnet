...
[Route("OrderItem")]
public class OrderItemController(IOrderItemService service, IMapper mapper) : Controller
{
    [HttpGet("Index")]
    ...
    public async Task<IActionResult> Edit(int id)
    {
        ...
        var dto = mapper.Map<OrderItem>(result);
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        var mapped = mapper.Map<OrderItem>(result);
        return View(mapped);
    }
